...
//     const projectContainers = document.querySelectorAll(".projects"); // Select all .projects containers
//     const dropdowns = document.querySelectorAll('.dropdown'); // Select all .dropdown buttons
//     const placeholders = document.querySelectorAll(".placeholder"); // Select all .placeholder elements
//
...
//     });
//
//     // Function to stack the cards in a specific container
//     function stackCards(container, dropdown, placeholder) {
//         const projects = container.querySelectorAll('.project');
//         const overlays = container.querySelectorAll('.overlay');
//         const titles = container.querySelectorAll('.project-title');
//
//         // Hide the dropdown and show the title when stacked
...
//     }
//
//     // Function to unstack the cards in a specific container
//     function unstackCards(container, dropdown, placeholder) {
//         const projects = container.querySelectorAll('.project');
//         const overlays = container.querySelectorAll('.overlay');
//         const titles = container.querySelectorAll('.project-title');
//
//         // Hide the title and show the dropdown when unstacked
...
//     }
//
//     // Add click event listener to each .projects container to toggle stacking/unstacking
//     projectContainers.forEach((container, i) => {
//         const toggleButton = container.querySelector('.project-title'); // Title button for toggling
//         const dropdown = dropdowns[i]; // Get the corresponding dropdown for this container
//         const placeholder = placeholders[i]; // Get the corresponding placeholder for this container
//
//         // Add an event listener for both the title and dropdown buttons
//         toggleButton.addEventListener('click', () => {
//             const isStacked = container.classList.contains('stacked');
//             if (isStacked) {
//                 unstackCards(container, dropdown, placeholder);
//                 container.classList.remove('stacked');
//             } else {
//                 stackCards(container, dropdown, placeholder);
...
//         });
//
//         // Initially stack the cards for each container
//         stackCards(container, dropdown, placeholder);
//     });
//
...
//                 stackCards(container, dropdowns[i], placeholders[i]); // Recalculate and reapply stacked widths on resize for each container
//             }
//         });
//     });
// });
...
function setSpacerHeight() {
    const height = document.getElementById("experience-spacer").offsetHeight;
